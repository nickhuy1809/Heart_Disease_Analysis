...
* **Description**: The dataset represents the health status of the U.S. adult population (2022). It includes **~445,000 records** with **40 features** covering:
    ...
    * **...**: Read the `Data_Explore.ipynb` for details
...
## 6. File structure
```
├── Planning.pdf  # Project Guidelines
├── Data_Explore.ipynb               # [Phase 1] Data Loading, Cleaning, EDA
├── Data_modeling.ipynb              # [Phase 2] Preprocessing, Sampling, Training
├── README.md                        # Project Documentation
└── requirements.txt                 # Dependencies
```

* **`Planning.pdf`**: Including work distributions and project timeline
* **`Data_Explore.ipynb`**:
...
3. **Run `Data_Explore.ipynb`**:
    ...
    * After that, it will create a new dataset named `cleaned_heart_data.csv` (at cell `101`)
